package com.nkwjg.autoscore;

import java.awt.*;
import javax.swing.*;

public class AutoScoreAppFixed extends JFrame {
    public AutoScoreAppFixed() {
        init();
        setSize(400, 350);
        ...
        try {
            ...
            if (d == result) {
                ...
                if (result == Double.valueOf(result).intValue()) {
                    disp += "×  结果应为" + Double.valueOf(result).intValue();
                } else {
                    disp += "×  结果应为" + result;
                }
            }
